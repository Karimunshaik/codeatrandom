...
<body>
   ...
   <?php include './includes/header.php' ?>
    ...
    <section class="home" id="home">
        ...
        <div class="content">
            <h2>It's a Good Habit to read<br /><span>Books</span></h2>
            <p>I can help you learn <span class="typing-text"> </span><br />And Grasp the Knowledge from the Books</p>
            <a href="./forms/register.php" class="btn"><span>Register</span>
                <i class="fa-solid fa-circle-right"></i>
            </a>
            <div class="socials">
                <ul class="social-icons">
                    <li><a class="linkedin" aria-label="LinkedIn" href="https://in.linkedin.com/?original_referer=https%3A%2F%2Fwww.google.com%2F" target="_blank"><i class="fab fa-linkedin"></i></a></li>
                    <li><a class="github" aria-label="GitHub" href="https://github.com/session" target="_blank"><i class="fab fa-github"></i></a></li>
                    <li><a class="telegram" aria-label="Telegram" href="https://web.telegram.org/a/" target="_blank"><i class="fab fa-telegram-plane"></i></a></li>
                    <li><a class="instagram" aria-label="Instagram" href="https://www.instagram.com/accounts/login/?hl=en" target="_blank"><i class="fab fa-instagram" target="_blank"></i></a></li>
                    <li><a class="dev" aria-label="Dev" href="https://youtube.com/@karimunshaik9864?si=h74x_qmHtqINBlIR" target="_blank"><i class="fa-brands fa-youtube"></i></a></li>
                </ul>
            </div>
        </div>
        <div class="image">
            <img draggable="false" class="tilt" src="./images/books.jpg" />
        </div>
    </section>
    <!-- Hero Section End  -->
    ...
    <section class="about" id="about">
        ...
        <div class="row">
            <div class="image">
                <img src="./images/girl1.jpg" draggable="false" class="tilt" alt="Hero" />
            </div>
            <div class="content">
                <h3>Hello, I'm Karimun</h3>
                ...
                <div class="profilebtn" style="margin-bottom:0px;">
                    <a href="#services" class="btn"><span>View more</span>
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            <div class="col">
                <div class="card h-100 d-flex align-items-stretch">
                    ...
                    <div class="card-body">
                        <h5 class="card-title" style="font-size: 2.5rem; text-align: center;"><strong>Panchatantra stories</strong></h5>
            ...
            <div class="col">
                <div class="card h-100 d-flex align-items-stretch">
                    <img src="./images/books.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title" style="font-size: 2.5rem; text-align: center;"><strong>Adventure in North pole</strong></h5>
            ...
            <div class="col">
                <div class="card h-100 d-flex align-items-stretch">
                    ...
                    <div class="card-body">
                        <h5 class="card-title" style="font-size: 2.5rem; text-align: center;"><strong> Programming books</strong></h5>
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="col">
                <div class="card h-100 d-flex align-items-stretch">
                    <img src="./images/books.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title" style="font-size: 2.5rem; text-align: center;"><strong>Python Course for Beginners in Hindi</strong></h5>
            ...
            <div class="col">
                <div class="card h-100 d-flex align-items-stretch">
                    <img src="./images/books.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title" style="font-size: 2.5rem; text-align: center;"><strong> Full Stack Web Development Full Course</strong></h5>
...
<section class="text-red-900 text-xl testimonial" id="testimonial">
    <h1 class="d-flex justify-content-center fs-1 fw-bold py-4">What Students Say about us?..</h1>
    <div class="container px-5 py-24 mx-auto">
        <div class="flex flex-wrap -m-4">
            <div class="lg:w-1/3 lg:mb-0 mb-6 p-4">
                <div class="h-full text-center">
                    <img alt="testimonial" class="w-20 h-20 mb-8 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-100" src="./images/girl1.jpg">
...
<section class="footer">
  ...
  <div class="box-container">
      ...
      <div class="box">
          ...
          <div class="share">
          <a class="linkedin" aria-label="LinkedIn" href="https://in.linkedin.com/?original_referer=https%3A%2F%2Fwww.google.com%2F" target="_blank"><i class="fab fa-linkedin"></i></a>
          <a class="github" aria-label="GitHub" href="https://github.com/session" target="_blank"><i class="fab fa-github"></i></a>
              <a href="mailto:codeatrandom@gmail.com" class="fas fa-envelope" aria-label="Mail" target="_blank"></a>
              <a class="telegram" aria-label="Telegram" href="https://web.telegram.org/a/" target="_blank"><i class="fab fa-telegram-plane"></i></a>
              <a class="dev" aria-label="Dev" href="https://youtube.com/@karimunshaik9864?si=h74x_qmHtqINBlIR" target="_blank"><i class="fa-brands fa-youtube"></i></a>
          </div>
      </div>
  </div>

  <h1 class="credit">Designed with <i class="fa fa-heart pulse"></i> by <a href="https://www.linkedin.com/in/imps1001"> Karimun</a></h1>
